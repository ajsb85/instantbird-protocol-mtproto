...
Account.prototype = {
  ...
  connect: function() {
    ...
    //Telegram Auth is a bit special
...
function TelegramProtocol() { }
TelegramProtocol.prototype = {
  __proto__: GenericProtocolPrototype,
  get name() "Telegram",
  get iconBaseURI() "chrome://prpl-telegram/skin/",
  get usernameEmptyText() "Your phone number with prefix",
  get passwordOptional() true,
  getAccount: function(aImAccount) new Account(this, aImAccount),
  classID: Components.ID("{0b90415e-1e2a-11e4-b062-000c29b161a5}"),
};

const NSGetFactory = XPCOMUtils.generateNSGetFactory([TelegramProtocol]);
